...
if (Meteor.isClient) {
  describe('Editor', function() {
    ...
    it('should render note not found message', function() {
      const wrapper = mount( <Editor call={call} browserHistory={browserHistory} selectedNoteId="thisisnotarealnoteid"/> );
    ...
    it('should not set state if note prop is not provided', function () {
      const wrapper = mount(<Editor browserHistory={browserHistory} call={call}/>);
